...
> **Frozen excerpt** of the canonical rappid contract (`rapp-rappid/2.0`). Bundled at planting time on 2026-05-09T12:52:53Z.
...
```
rappid:v2:<kind>:@kody-w/pkstop-central-park-bandshell:<32-hex>@github.com/kody-w/pkstop-central-park-bandshell
```
